<html>
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="/css/mrjuliuss/lecter/lecter.css">
        <link rel="stylesheet" type="text/css" href="/css/mrjuliuss/lecter/bootswatch.css">
        ...
        <script type="text/javascript" src="//cdnjs.cloudflare.com/ajax/libs/react/0.13.1/react.js"></script>
            ...
            @else
                ...
                <script type="text/javascript" src="/js/mrjuliuss/lecter/editor.js"></script>
            @endif
        @endif
        ...
        <script type="text/javascript" src="/js/mrjuliuss/lecter/lecter.js"></script>
